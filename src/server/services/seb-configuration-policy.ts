...
export function macOSBrowserUserAgentSettings(): Record<string, unknown> {
...
export const MACOS_LOCKDOWN_SETTINGS: Readonly<Record<string, unknown>> = {
...
export const ASSESSMENT_LOCKDOWN_SETTINGS: Readonly<Record<string, unknown>> = {
...
export function browserExamKey(courseId: string, contentId: string, accessCode: string): string {
