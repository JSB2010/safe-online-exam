...
| `ASSESSMENT_NOT_AVAILABLE`            | Canvas did not expose the exact assessment to this learner, or it is explicitly unpublished, future, or closed. If it was just published, refresh Canvas and retry after a few seconds; otherwise check publication, dates, and differentiated assignment rules. |
