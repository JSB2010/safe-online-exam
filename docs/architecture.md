...
| Canvas OAuth and APIs     | `oauth.controller.ts`, `canvas-api.service.ts`                              | One durable per-user grant, administrator scope upgrades, token refresh, bounded Canvas REST/New Quiz requests.       |
